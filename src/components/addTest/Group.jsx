            ...
            >
              <Row gutter={2} type="flex" justify="space-around">
                ...
                <div style={{ marginTop: 25, marginLeft: 10, fontSize: 30 }}>
                  ...
                  <Button onClick={() => props.onClickdeleteHeader(columnId)} type="primary" shape="circle" size="large" style={{ background: '#F4A940', color: '#FFFFFF' }}>x</Button>
                </div>
              </Row>
              <div style={{ margin: 8 }}>
                                    ...
                                    <div>
                                      <Row gutter={24} type="flex" justify="space-around">
                                        ...
                                        <div style={{ marginTop: 40, marginLeft: 10, fontSize: 30 }}>
                                          <Button onClick={() => props.onClickdeletColumn(columnId, index)} type="primary" shape="circle" size="large" style={{ background: '#F4A940', color: '#FFFFFF' }}>x</Button>
                                        </div>
                                      </Row>
                                    </div>
                                  </div>
