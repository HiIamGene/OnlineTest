...
const CompetencyEdit = ({countries,onChangeDate ,t,editMode,errors,onSubmit,openModal,setLicense,licenses,licenseData , onEditMode , onChange,onSelect , onTyping , onUploadImageForProfile}) => (
        ...
        <Form onSubmit={(e)=> onSubmit(e)}>
            ...
            <div className={"cr-flex"}>
                 <div className="master-logo-container1 mr-20">
                     <img src={"/static/images/icon/AW_CrewHitz_ICON-76.png"}
            ...
            <Row>
                <Col md={4} sm={6} className="about-btn-wrapper">
                    <Button className="about-btn-cancel" onClick={onEditMode}  block>{t("cancelButtonLicense")}</Button>
                </Col>
                <Col md={4} sm={6} className="about-btn-wrapper">
                    <Button className="about-btn-save" type="submit" block >{t("saveButtonLicense")}</Button>
                </Col>
            </Row>
