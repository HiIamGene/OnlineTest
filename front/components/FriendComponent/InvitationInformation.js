        ...
        return(
            <div className="friend-information-wrapper">
                <div className="image-state">
                    <img src="../static/images/friend/profile.jpeg" alt="invitation_friends"/>
                </div>
                <div className="information-state">
                    <p className="p-name">Paranyu Hong</p>
                    <p>Caption</p>
                    <p>Ship Expert</p>
                </div>
                <div className="connection-state">
                    <div className="button-state">
                        <button className="button-connected"><i className="fas fa-plus"/> Connect</button>
                    </div>
                </div>
                <style jsx>{`
...
export default Invitationnformation